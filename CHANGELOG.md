...
- Add a real Cursor + Houdini chess-set screenshot and the prompts that built it to the Houdini install guides, including the root README and `houdini-mcp/README.md` hero images.
