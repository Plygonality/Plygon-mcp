...
set "INSTALLER=%REPO_ROOT%\houdini-mcp\scripts\install_package.py"
if not exist "%INSTALLER%" (
  echo Missing %INSTALLER% — run this from a Plygon-mcp checkout, not a Cursor cache folder named houdini-mcp.
  exit /b 1
)
...
:run
echo Installing Plygon Houdini MCP from %REPO_ROOT%
